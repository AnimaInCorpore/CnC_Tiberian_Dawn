...
| `TEXT.CPP` | `src/text.cpp` | Font header parsing fixed to treat the packed 14-byte header correctly and reject bogus headers so we fall back to the built-in 8x8 font when assets are missing. |
