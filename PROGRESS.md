...
| `PALETTE/UI` | `src/port_runtime.cpp`, `src/load_title.cpp` | Seeded a canonical base palette from `TEMPERAT.PAL` and preserved UI-reserved indices (0..15 + CC_GREEN_* range) when applying the title palette, fixing black/incorrect main-menu dialog & text colors. |
