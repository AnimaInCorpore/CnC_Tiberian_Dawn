...
- Finish Win95 main menu/game selection parity: new game/campaign progression and any remaining selection/menu flow differences (`Select_Game()`, `Main_Menu()`) (`src/port_runtime.cpp`, `src/menus.cpp`).
