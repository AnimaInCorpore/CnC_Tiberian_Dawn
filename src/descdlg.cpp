...
void DescriptionClass::Process(char* string)
{
    ...
    */
    ...
    -----------------------------------------------------------------------
    */
    int button_width = MAX((String_Pixel_Width(Text_String(TXT_OK)) + 8), 30);
    button_width = MAX(button_width, MAX((String_Pixel_Width(Text_String(TXT_CANCEL)) + 8), 30));

    TextButtonClass optionsbtn(BUTTON_OPTIONS, TXT_OK, TPF_6PT_GRAD, 0, BUTTON_Y, button_width);

    TextButtonClass cancelbtn(BUTTON_CANCEL, TXT_CANCEL, TPF_6PT_GRAD, 0, BUTTON_Y, button_width);
