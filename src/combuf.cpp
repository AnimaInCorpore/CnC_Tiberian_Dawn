...
void CommBufferClass::Mono_Debug_Print(int refresh)
{
	...
	if (refresh) {
		...
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ﾃﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾆﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄｴ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
...
void CommBufferClass::Mono_Debug_Print2(int refresh)
{
	...
	if (refresh) {
		...
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ﾃﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾆﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄﾄｴ\n");
		Mono_Printf("ｳ         ID #    Sends  ACK   Desc    ｳ         ID #    Read  ACK   Desc    ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
		Mono_Printf("ｳ                                      ｳ                                      ｳ\n");
	...
	------------------------------------------------------------------------*/
	for (i = 0; i < MaxSend; i++) {
		Mono_Set_Cursor (1,i + 8);
		if (SendQueue[i].IsActive) {
			hdr = (CommHdr *)SendQueue[i].Buffer;
			val = hdr->Code;
			Mono_Printf ("   %4d      %2d    %d", hdr->PacketID, SendQueue[i].SendCount,
				SendQueue[i].IsACK);
			if (DebugNames && DebugSize && DebugOffset && DebugMaxNames) {
				memcpy((char *)&val, (char *)SendQueue[i].Buffer + DebugOffset, DebugSize);
				sprintf(txt, "%3d", val);
				Mono_Set_Cursor (16,i + 8);
				Mono_Printf (txt);
				Mono_Set_Cursor (29,i + 8);
				Mono_Printf (DebugNames[val]);
			}
		} else {
			Mono_Printf ("   ____      __    _");
		}
	...
	for (i = 0; i < MaxReceive; i++) {
		...
		if (ReceiveQueue[i].IsActive) {
			...
			Mono_Printf ("   %4d      %d    %d", hdr->PacketID, ReceiveQueue[i].IsRead,
				ReceiveQueue[i].IsACK);
			if (DebugNames && DebugSize && DebugOffset && DebugMaxNames) {
				memcpy((char *)&val, (char *)ReceiveQueue[i].Buffer + DebugOffset, DebugSize);
				sprintf(txt, "%3d", val);
				Mono_Set_Cursor (54,i + 8);
				Mono_Printf (txt);
				Mono_Set_Cursor (67,i + 8);
				Mono_Printf (DebugNames[val]);
			}
		} else {
			Mono_Printf ("   ____      _    _");
