...
ScoreScaleClass::ScoreScaleClass(void const * string, int xpos, int ypos, void const* palette) :
	ScoreAnimClass(xpos, ypos, string)
{
	Palette = palette;
	Stage = 5;
...
void ScoreClass::Show_Credits(int house, void const* pal)
{
 ...
 *=============================================================================================*/
void ScoreClass::Input_Name(char str[], int xpos, int ypos, void const* pal)
{
