...
class ScoreClass {
	...
	private:
		...
		void Count_Up_Print(char const* str, int percent, int max, int xpos, int ypos);
		void Show_Credits(int house, void const* pal);
		...
		void Input_Name(char str[], int xpos, int ypos, void const* pal);
};
...
class ScoreScaleClass : public ScoreAnimClass {
	public:
		...
		void const* Palette;
		virtual void Update(void);
		ScoreScaleClass(void const * data, int xpos, int ypos, void const* pal);
